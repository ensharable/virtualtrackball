...
class Box{
  ...
  static void setup(WebGL.RenderingContext gl) {
    ...
    gl.bindBuffer(WebGL.RenderingContext.ELEMENT_ARRAY_BUFFER, vertexBuffer);
    ...
    gl.bindBuffer(WebGL.RenderingContext.ELEMENT_ARRAY_BUFFER, verticesColorBuffer);
    gl.bufferDataTyped(WebGL.RenderingContext.ELEMENT_ARRAY_BUFFER, colorArray,
        WebGL.RenderingContext.STATIC_DRAW);
  }
